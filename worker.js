...
function movementAnalysis(
  ...
  /*
   * LONG sweep یعنی Sell-side Liquidity Sweep
   * و از نظر جهت حرکت، نشانه بالقوه صعود است.
   */
  if(
    h.confirmed &&
    h.side==="LONG"
  ...
  /*
   * SHORT sweep یعنی Buy-side Liquidity Sweep
   * و از نظر جهت حرکت، نشانه بالقوه نزول است.
   */
  if(
    h.confirmed &&
    h.side==="SHORT"
